...
public class CreateCommonLocalization
{
    ...
    [MenuItem("Data Files/Localization/Build Common")]
    public static void BuildCommonLocalization()
    {
        foreach (string locale in locales)
        {
            ...
            {
                string localizationKey = "bonusStatType." + x;
                ...
                else
                {
                    ...
                    {
                        localization[localizationKey] = SplitCamelCase(x);
                    }
            ...
            List<string> groupTypes = new List<string>(Enum.GetNames(typeof(TagType)));

            foreach (string x in groupTypes)
            {
                string localizationKey = "tagType." + x;
                string pluralLocalizationKey = "tagType." + x + ".plural";
                string restrictionLocalizationKey = "tagType." + x + ".restriction";
            ...
            Debug.Log("Completed common localization json");
        }
    }

    [MenuItem("Data Files/Localization/Build UI Strings")]
